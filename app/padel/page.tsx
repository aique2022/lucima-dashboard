...
export default function PadelPage() {
  ...
  const { data, error, isLoading } = useFetchData<any>(
    `/transactions/padel?page=${page}&limit=${pageSize}${dateRangeQuery}&transStatus=${transStatus}&search=${debounced}`
  );
      ...
      <SidebarInset>
        ...
        <main className="flex flex-col gap-4 min-h-full p-4 sm:p-6 lg:p-8">
          <div className="flex justify-between items-center">
            <h2 className="text-2xl font-bold">Manila Padel Club</h2>
          </div>
